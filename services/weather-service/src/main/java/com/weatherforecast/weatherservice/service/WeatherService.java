...
public interface WeatherService {
   ...
   *
   * @param location A string representing the location name, city, address, or identifier
   * @return A Mono emitting the weather data for the specified location when available
   */
