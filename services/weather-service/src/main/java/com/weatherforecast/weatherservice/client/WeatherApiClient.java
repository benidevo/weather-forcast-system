...
public interface WeatherApiClient {
     ...
     * @return A Mono containing the WeatherData with current conditions, forecast
     *         and alerts
     * @throws WebClientResponseException if there is an error calling the weather
     *                                    API
     * @throws CircuitBreakerException    if the circuit breaker is open due to too
     *                                    many failures
     */
     ...
     * @return A Mono containing the Coordinates (latitude and longitude) for the
     *         specified location
     *
     * @throws WebClientResponseException if there is an error calling the geocoding
     *                                    API
     * @throws CircuitBreakerException    if the circuit breaker is open due to too
     *                                    many failures
     */
