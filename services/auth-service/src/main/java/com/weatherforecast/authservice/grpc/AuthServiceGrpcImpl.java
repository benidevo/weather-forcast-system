...
public class AuthServiceGrpcImpl extends AuthServiceGrpc.AuthServiceImplBase {
  ...
  public void login(LoginRequest request, StreamObserver<AuthResponse> responseObserver) {
    ...
    try {
      ...
      log.error(
          "Error during authentication for user with username {}: {}", username, e.getMessage());
      responseObserver.onError(
  ...
  public void register(
      RegisterRequest request, StreamObserver<RegistrationResponse> responseObserver) {
    String username = request.getUsername();
    String password = request.getPassword();
    ...
    try {
      ...
      log.error(
          "Error during registration for user with username {}: {}", username, e.getMessage());
      responseObserver.onError(
          Status.INTERNAL.withDescription("Something went wrong").asRuntimeException());
    }
  }
  ...
  public void updatePassword(
      UpdatePasswordRequest request, StreamObserver<UpdateResponse> responseObserver) {
    String username = request.getUsername();
    ...
    try {
      ...
      log.error(
          "Error during password update for user with username {}: {}", username, e.getMessage());
      responseObserver.onError(
          Status.INTERNAL.withDescription("Something went wrong").asRuntimeException());
    }
  }
  ...
  public void updateUsername(
      UpdateUsernameRequest request, StreamObserver<UpdateResponse> responseObserver) {
    ...
    try {
      ...
      log.error(
          "Error during username update for user with username {}: {}",
          oldUsername,
          e.getMessage());
      responseObserver.onError(
          Status.INTERNAL.withDescription("Something went wrong").asRuntimeException());
